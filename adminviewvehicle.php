      ...
      <div class="row py-md-5 py-sm-3">
        <div class="col-md-6">
                <form id="contact-form" name="myForm" class="form" action="#" onsubmit="return validateForm()" method="POST">
                  ...
                  <?php
			$qry="select * from vechicle where status='not approved'";
			$rs=mysql_query($qry);
			$i=1;
			...
			echo "<td>".$rs1['dname']."</td>";
			echo "<td>".$rs1['vehi_no']."</td>";
			echo"<td>".$rs1['vechi_name']."</td>";
		    echo"<td>".$rs1['seat_capacity']."</td>";
			
			echo "<td>".$rs1['vechi_tpe']."</td>";

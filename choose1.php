...
while($row = mysql_fetch_array($result))
  {
  echo "<tr>";
    echo "<td>" . $row['vehi_no'] . "</td>";
  echo "<td>" . $row['vechi_name'] . "</td>";
 $vname=$row["vechi_name"];
  echo "<td>" . $row['seat_capacity'] . "</td>";
  echo "<td>" . $row['vechi_tpe'] . "</td>";
  echo "<td>" . $row['amount'] . "</td>";
$lname=$row['vehi_no'];
echo "<td><a href='vehiclebooking.php?Vechi_name=$lname'/>click</a></td>";

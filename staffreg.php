...
?>
        ...
        <div class="col-md-6">
                 ...
                 <form id="contact-form" name="myForm" class="form" action="#" onsubmit="return validateForm()" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="fname" name="fname" placeholder="Enter firstname" tabindex="1">
                    </div>
                    <div class="form-group">
                        <label class="form-label" id="lastname" for="lastname">lastname</label>
                        <input type="text" class="form-control" id="lname" name="lname" placeholder="enter lastname" tabindex="2">
  ...
  <input type="radio" name="type" value=" gender">  Female
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="place" name="place" placeholder="enter place" tabindex="2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="email" name="email" placeholder="enter email" tabindex="2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="mobileno" name="mobileno" placeholder="enter mobileno" tabindex="2">
  ...
  <?php
	...
	$dclass=$_REQUEST['class'];
	$damount=$_REQUEST['ammount'];
	...
	{
					$qry="insert into darshanam(cname,amount) values('$dclass','$damount')";

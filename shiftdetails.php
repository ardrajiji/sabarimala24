...
?>
    ...
    <div class="container py-lg-5 mt-sm-5 mt-3">
		...
		<div class="w3ls-titles text-center mb-5">
				<h3 class="title">SHIFTDETAILS</h3>
				<span class="btmspn">
        ...
        <div class="col-md-6">
                <form id="contact-form" name="myForm" class="form" action="#" onsubmit="return validateForm()" method="POST">
                    <div class="form-group">
                        <label class="form-label" id="vechi_type" for="vechi_type">vehicletype</label>
                        <input type="text" class="form-control" id="vechi_type" name="vechi_type" placeholder="enter vehicletype" tabindex="2">
                    </div>
                    ...
                    <div class="form-group">
                        <label class="form-label" id="status" for="status">status</label>
                        <input type="text" class="form-control" id="status" name="status" placeholder="enter status" tabindex="4">
                    </div>
...
if(isset($_REQUEST['submit']))
{
	...
	{*/
	$qry="insert into parking(vechi_type,amount,status) values('$vtype','$amount','$status')";

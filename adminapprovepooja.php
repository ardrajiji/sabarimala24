      ...
      <div class="row py-md-5 py-sm-3">
        <div class="col-md-6">
                <form id="contact-form" name="myForm" class="form" action="#" onsubmit="return validateForm()" method="POST">
                  ...
                  <?php
			$qry="select * from poojabooking where status='not approved'";
			$rs=mysql_query($qry);
			$i=1;
			...
			echo "<tr>";
			echo "<td>".$rs1['pid']."</td>";
			echo "<td>".$rs1['poojaname']."</td>";
			echo "<td>".$rs1['amount']."</td>";
			echo"<td>".$rs1['username']."</td>";
		    echo"<td>".$rs1['status']."</td>";
			
			
				echo "<td><input type='checkbox' name='check[$i]' value='".$rs1['pid']."'/></td>";
			echo "</tr>";
				 ...
				 if(isset($_POST['check']))
				  {
					  foreach($_POST['check'] as $value)
					  {
						  ...
						  $sql="update poojabooking set status='approved' where pid='$value'";
						  mysql_query($sql);

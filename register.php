...
<body>
    <!-- banner -->
<div class="col-lg-6 callnumber text-left"></div>
...
<div class="container py-lg-5 mt-sm-5 mt-3">
		...
		<div class="w3ls-titles text-center mb-5">
				<h3 class="title"><span class="hdng">LOGIN  </span>us</h3>
				<span class="btmspn">
          ...
          <div class="col-md-6" >
                <form id="contact-form" name="myForm" class="form" action="#" onsubmit="return validateForm()" method="POST">
                    <div class="form-group">
                        <label class="form-label" id="username" for="name"></label>
                        <input type="text" class="form-control" id="username" name="username" placeholder="user name" tabindex="1">
                    </div>
                    <div class="form-group">
                        <label class="form-label" id="password" for="password"></label>
                        <input type="text" class="form-control" id="password" name="password" placeholder="Your password" tabindex="2">
                    </div>
                  
                    
                    
                    <div class="text-center mt-5">
                        <button type="submit" class="serv_bottom btn btn-border btn-lg w-100">submit</button>
                    </div>
                </form>
            </div>

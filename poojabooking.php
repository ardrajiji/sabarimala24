...
?>
                    ...
                    <ul class="navbar-nav ml-lg-auto text-center">
                        ...
                        <li class="nav-item dropdown mr-lg-3">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="vehicle.php">Pooja</a>
        ...
        <div class="col-md-6">
                <form id="contact-form" name="myForm" class="form" action="#" onsubmit="return validateForm()" method="POST">
                    <div class="form-group">
                        ...
                        <label class="form-label" id="ammount" for="poojaname"></label>
                        <input type="text" class="form-control" id="poojaname" name="poojaname" placeholder="enter Pooja" tabindex="2">
                       
                    </div>
                    <div class="form-group">
                        <label class="form-label" id="ammount" for="ammount"></label>
                        <input type="text" class="form-control" id="ammount" name="ammount" placeholder="enter ammount" tabindex="2">
                    </div>
   ...
   <?php
	...
	{
					$qry="insert into poojabook(poojaname,amount) values('$dclass','$damount')";

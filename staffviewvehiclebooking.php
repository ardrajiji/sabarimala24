...
?>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-lg-auto text-center">
                        <li class="nav-item active  mr-lg-3">
                            <a class="nav-link" href="staffhome.php">Home
                        ...
                        <li class="nav-item  mr-lg-3">
                         ...
                         <li class="nav-item  mr-lg-3">
                            <a class="nav-link" href="driverstaffshift.php">shiftstatus</a>
                        </li>
                       <li class="nav-item  mr-lg-3">
                            <a class="nav-link" href="staffviewvehiclebooking.php">View Booking</a>
                        </li>
                        <li class="nav-item  mr-lg-3">
   ...
   <table border="1" align="center" width="1000" height="200">
  	<tr><th>User Name</th><th>Phone Number</th><th>Date</th><th>Vehicle</th><th>StartLocation</th><th>EndLocation</th><th>No Of Persons</th><th>No Of Days</th></tr>
  	<?php
	  
	   session_start();
	   $sn=$_SESSION['UserName'];
	
		$qry="select * from vehiclebooking where dname='$sn' and status='approved'";
		$res=mysql_query($qry);
	...
	while($data=mysql_fetch_assoc($res))
	{
		...
		$np=$data["noofperson"];
		$nd=$data["noofdays"];
		echo "<tr><td>$un</td><td>$sub</td><td>$ven</td><td>$sta</td><td>$sl</td><td>$el</td><td>$np</td><td>$nd</td></tr>";

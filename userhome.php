                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-lg-auto text-center">
                        ...
                        <li class="nav-item dropdown mr-lg-3">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="darshanambooking.php">Darshanam</a>
                                <a class="dropdown-item" href="lodgebooking.php">Lodge</a>
                                <a class="dropdown-item" href="userviewvehicles.php">Vehicle</a>
                                <a class="dropdown-item" href="userpoojabook.php">Pooja</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="userviewparking.php">Parking</a>
                            </div>
                        ...
                        statusview
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="userdarshanamview.php">Darshanam</a>
                                <a class="dropdown-item" href="userviewlodgebooking.php">Lodge</a>
                                <a class="dropdown-item" href="userviewbookingstatus.php">Parking</a>
                                <a class="dropdown-item" href="userviewvehiclebooking.php">Vehicle</a>
                                   <a class="dropdown-item" href="userviewpoojastatus.php">Pooja</a>
                                <div class="dropdown-divider"></div>
                            </div>
                        </li>

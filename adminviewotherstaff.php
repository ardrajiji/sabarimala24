      ...
      <div class="row py-md-5 py-sm-3">
        <div class="col-md-6">
                <form id="contact-form" name="myForm" class="form" action="#" onsubmit="return validateForm()" method="POST">
                  ...
                  <?php
			$qry="select * from otherstaff where status='not approved'";
			$rs=mysql_query($qry);
			$i=1;
			...
			echo "<td>".$rs1['fname']."</td>";
			echo "<td>".$rs1['age']."</td>";
			echo"<td>".$rs1['gender']."</td>";
		    echo"<td>".$rs1['place']."</td>";
			
			echo "<td>".$rs1['email']."</td>";
			echo "<td>".$rs1['phoneno']."</td>";
			echo "<td>".$rs1['aadar']."</td>";
				echo "<td><input type='checkbox' name='check[$i]' value='".$rs1['email']."'/></td>";
			echo "</tr>";
				 ...
				 if(isset($_POST['check']))
				  {
					  foreach($_POST['check'] as $value)
					  {
						  ...
						  $sql="update otherstaff set status='approved' where email='$value'";
						  mysql_query($sql);

...
?>
    ...
    <div class="container py-lg-5 mt-sm-5 mt-3">
		...
		<div class="w3ls-titles text-center mb-5">
				<h3 class="title">Driver Shift allotment</h3>
				<span class="btmspn">
...
//                alert(progId)
                ...
                if (obj != null)
                {
                    ...
                    obj.open('post', 'ajax/viewstaffallot.php?snm='+ a, true);
                    obj.send(null);
                }
...
if(isset($_REQUEST['submit']))
{
	...
	$qry="insert into staff_allot(staffname,shifttype,date_allot) values('$stname','$type','$sdate')";

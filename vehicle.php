        ...
        <div class="col-md-6">
                <form id="contact-form" name="myForm" class="form" action="#" onsubmit="return validateForm()" method="POST">
                    <div class="form-group">
                        <label class="form-label" id="vechi_no" for="vechi_no">vechi_no</label>
                        <input type="text" class="form-control" id="vechi_no" name="vechi_no" placeholder="Enter vechi_no" tabindex="1">
                    </div>
                    <div class="form-group">
                        <label class="form-label" id="Vechi_name" for="v">vehiclename</label>
                        <input type="text" class="form-control" id="Vechi_name" name="Vechi_name" placeholder="enter Vechicle name" tabindex="2">
                    </div>
                    
                    <div class="form-group">
                        <label class="form-label" id="seat_capacity" for="seat_capacity">seat_capacity</label>
                        <input type="text" class="form-control" id="seat_capacity" name="seat_capacity" placeholder="Enter  no of seats" tabindex="3">
                    </div>
                    <div class="form-group">
                        <label class="form-label" id="Vechi_tpe" for="Vechi_tpe">Vechi_tpe</label>
                        <input type="text" class="form-control" id="Vechi_tpe" name="Vechi_tpe" placeholder="enter Vechicle type" tabindex="4">
                    </div>
                    
                     <div class="form-group">
                        <label class="form-label" id="amount" for="amount">amount</label>
                        <input type="text" class="form-control" id="amount" name="amount" placeholder="enter amount" tabindex="5">
                    </div>

...
while($row = mysql_fetch_array($result))
  {
	  $image=$row['image'];
  echo "<tr>";
  echo "<td>" . $row['lodge_name'] . "</td>";
  echo "<td>" . $row['location'] . "</td>";
  echo "<td>" . $row['type_room'] . "</td>";
  echo "<td>" . $row['type'] . "</td>";
  echo "<td>" . $row['number_of_room'] . "</td>";
  echo "<td>" . $row['amount'] . "</td>";
	  echo "<td><img src='images/".$image."' width=300 height=200></td>";
	  echo "<td>" . $row['rating'] . "</td>";
	 
	  $_SESSION['$amt']=$row['amount'];
	   $amt=$row['amount'];
 $lname=$row['lodge_name'];
echo "<td><a href='lodgebooking.php?lodgename=$lname&amount=$amt' name='check[$i]'>click</a>";   
  echo "</tr>";
  $i++;
  }
echo "</table>";

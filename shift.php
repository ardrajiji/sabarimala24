        ...
        <div class="col-md-6">
                <form id="contact-form" name="myForm" class="form" action="#" onsubmit="return validateForm()" method="POST">
                    <div class="form-group">
                        <label class="form-label" id="Shifttype" for="Shifttype">Shifttype</label>
                        <input type="text" class="form-control" id="Shifttype" name="Shifttype" placeholder="Enter Shifttype" tabindex="1">
                    </div>
                    <div class="form-group">
                        <label class="form-label" id="descshift" for="descshift"></label>
                        <input type="text" class="form-control" id="descshift" name="descshift" placeholder="enter descshift" tabindex="2">
                    </div>
...
if(isset($_REQUEST['submit']))
{
	...
	$qry="insert into shift_details(Shifttype,descshift) values('$type','$des')";
	mysql_query($qry);	

...
?>
        ...
        <div class="col-md-6">
                <form id="contact-form" name="myForm" class="form" action="#" onsubmit="return validateForm()" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="class" name="class" placeholder="Enter Pooja" tabindex="1">
                    </div>
                    <div class="form-group">
                        <label class="form-label" id="ammount" for="ammount"></label>
                        <input type="text" class="form-control" id="ammount" name="ammount" placeholder="enter amount" tabindex="2">
                    </div>
   ...
   <?php
	...
	$damount=$_REQUEST['ammount'];
				$qry="select count(*) as cnt from poojabook where poojaname='$dclass'";
	$rs=mysql_query($qry);

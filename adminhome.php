                    ...
                    <ul class="navbar-nav ml-lg-auto text-center">
                        ...
                        <li class="nav-item dropdown mr-lg-3">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="adminaddpooja.php">Pooja</a>
                         ...
                         <li class="nav-item dropdown mr-lg-3">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="shiftallotment.php">Shiftallotment</a>
                                <a class="dropdown-item" href="adminaddotherstaffshift.php">OtherstaffShiftallotment</a>
                            </div>
                        </li>
                        ...
                        statusview
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="adminviewdarshanamm.php">Darshanam</a>
                                 <a class="dropdown-item" href="adminviewvehicle.php">Vehicle</a>
                                <a class="dropdown-item" href="adminviewlodge.php">Lodge</a>
                                 <a class="dropdown-item" href="adminviewvehiclebooking.php">Vehicle Booking</a>
                                <a class="dropdown-item" href="adminviewotherstaff.php">Otherstaff</a>
                                <a class="dropdown-item" href="adminviewparkingbooking.php">Parking booking</a>
                                 <a class="dropdown-item" href="adminapprovepooja.php">Pooja</a>
                                <div class="dropdown-divider"></div>
                               
                            </div>
                        </li>
                         <li class="nav-item  mr-lg-3">
                            <a class="nav-link" href="adminviewaccount.php">View Account</a>
                        </li>
                         <li class="nav-item  mr-lg-3">
                    ...
                    <ul class="rslides" id="slider3">
                        <li>
                            <div class="slider-info">
                                <h3>SWAMIYE SHARANAM AYYAPPA</h3>

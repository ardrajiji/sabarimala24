...
?>
    ...
    <div class="container py-lg-5 mt-sm-5 mt-3">
      ...
      <div class="row py-md-5 py-sm-3">
       ...
       <h5 align="left" style="color: red">Note:status=1 means approved</h5>
     	<th>Name</th>
     	<th>Phone Number</th>
     	<th>Date</th>
     	<th>Lodge Name</th>
		 ...
		 $re=mysql_query("select * from lodgebooking where nam='$uname'");
		 ...
		 $dn=$res['date1'];
			 ...
			 echo "<tr><td>$na</td><td>$vn</td><td>$dn</td><td>$ln</td><td>$nm</td><td>$nd</td><td>$am</td><td>$st</td></tr>";
		 }

...
<body onLoad="myFunction()">
    ...
    <div>
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td align="center" >
                    <img alt="" class="auto-style20" src="Payment/Images/loading.gif" /></td>
                <td class="auto-style19"></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td style="text-align: center">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <img alt="" class="auto-style18" src="Payment/Images/Process1.JPG" /></td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
    ...
    <script>
function myFunction() {
  setTimeout(function(){ window.location.href="Fourth.php"; }, 3000);
}
</script>
</body>
</html>

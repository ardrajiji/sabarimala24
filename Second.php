            ...
            <td class="auto-style58"><fieldset>
                <table class="auto-style1">
                    <tr>
                        ...
                        <td>
                        <span class="auto-style62"></span><input type="text" name="name1" readonly=true; value="23654875216"/></td>
                    </tr>
                    <tr>
                        <?php 
                        ...
                        <td class="auto-style26">
                            <span class="auto-style62"></span><input type="text" name="name" readonly=true; value="<?php echo $b;?> "/>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; The billing address is used to prevent fraud by matching it to your account information, enter this as close to the way it appears on your card statement
                    ...
                    <tr>
					    ...
					    {
							$res=mysql_query("select * from customer_reg where cid='".$_SESSION['uid']."'");
                    ...
                    <tr>
					    ...
					    if(isset($_REQUEST['pay']))
					    {
							...
							$cash=$adamt+$m;
							echo $cash;
							$jj="insert into adminaccount(date,account,amount) values('$da','23654875216','$m')";
							echo $jj;
							$gg=mysql_query($jj);
							$ll=mysql_query("select amount from signup where account='$p'");
							$xx=mysql_fetch_array($ll);
							$uamt=$xx['amount'];
							$ww=$uamt-$m;
							$uu=mysql_query("update signup set amount='$ww' where account='$p'");

	...
	<section class="welcome py-5">
		<div class="container py-md-4 mt-md-3">
			<div class="w3ls-titles text-center">
				<h3 class="title"><span class="hdng">Pooja Timings at Sabarimala   </span>Us</h3>
				<span class="btmspn">
        ...
        <p align="left">&nbsp;</p>
        <table border="0" cellspacing="2px" cellpadding="2px" width="860">
          <tr>
            <td width="825" colspan="2" style="font-size: large"><p><strong style="font-size: x-large">Morning</strong></p></td>
          </tr>
          <tr>
            <td width="446" style="font-size: large"><p>Opening of sanctum sanctorum</p></td>
            <td width="379" style="font-size: large"><p>4.00 a.m.</p></td>
          </tr>
          <tr>
            <td width="446" style="font-size: large"><p>Nirmalya darshanam</p></td>
            <td style="font-size: large"><p>4.05 a.m.</p></td>
          </tr>
          <tr>
            <td width="446" style="font-size: large"><p>Ganapati homam</p></td>
            <td style="font-size: large"><p>4.15 a.m.</p></td>
          </tr>
          <tr>
            <td width="446" style="font-size: large"><p>Neyyabhishekam</p></td>
            <td style="font-size: large"><p>4.15 a.m. to 12.00 p.m</p></td>
          </tr>
          <tr>
            <td width="446" style="font-size: large"><p>Usha pooja</p></td>
            <td style="font-size: large"><p>7.30 a.m.</p></td>
          </tr>
          <tr>
            <td width="446" style="font-size: large"><p>Kalabhabhishekam</p></td>
            <td style="font-size: large"><p>12.30 p.m.</p></td>
          </tr>
          <tr>
            <td width="446" style="font-size: large"><p>Ucha pooja</p></td>
            <td style="font-size: large"><p>1.00 p.m.</p></td>
          </tr>
          <tr>
            <td width="446" style="font-size: large"><p>Closing of sanctum sanctorum</p></td>
            <td style="font-size: large"><p>1.30 p.m.</p></td>
          </tr>
          <tr>
            <td width="825" colspan="2" style="font-size: large"><p><strong style="font-size: x-large">Evening</strong></p></td>
          </tr>
          <tr>
            <td width="446" style="font-size: large"><p>Opening of sanctum sanctorum</p></td>
            <td style="font-size: large"><p>4.00 p.m.</p></td>
          </tr>
          <tr>
            <td width="446" style="font-size: large"><p>Deeparadhana</p></td>
            <td style="font-size: large"><p>6.30 p.m.</p></td>
          </tr>
          <tr>
            <td width="446" style="font-size: large"><p>Pushpabhishekam</p></td>
            <td style="font-size: large"><p>7.00 p.m.</p></td>
          </tr>
          <tr>
            <td width="446" style="font-size: large"><p>Athazha pooja</p></td>
            <td style="font-size: large"><p>10.30 p.m.</p></td>
          </tr>
          <tr>
            <td width="446" style="font-size: large"><p>Harivarasanam</p></td>
            <td style="font-size: large"><p>10.50 p.m.</p></td>
          </tr>
          <tr>
            <td width="446" style="font-size: large"><p>Closing of sanctum sanctorum</p></td>
            <td style="font-size: large"><p>11.00 p.m.</p></td>
          </tr>
        </table>
<p align="left">&nbsp;</p>

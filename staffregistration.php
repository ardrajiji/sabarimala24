...
?>
        ...
        <div class="col-md-6">
                ...
                <form id="contact-form" name="myForm" class="form" action="#" onsubmit="return validateForm()" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="age" name="age" placeholder="Enter age" tabindex="3" pattern="[0-9]{2}"title="enter digits only" required>
                    </div>
  ...
  <input type="radio" name="gender" value=" gender">  Female
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="mobileno" name="mobileno" placeholder="enter mobileno" tabindex="2" maxlength="10" pattern="[0-9]{10}"title="enter digits only" required>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="place" name="vechi_name" placeholder="enter Vehicle" tabindex="2" >
                        
                    </div> 
                    <div class="form-group">
                        <label class="form-label" id="mobileno" for="mobileno">Seat Capacity</label>
                        <input type="text" class="form-control" id="mobileno" name="seat_capacity" placeholder="enter Capacity" tabindex="2" maxlength="10" pattern="[0-9]+" title="enter digits only" required>
					</div>
                        <div class="form-group">
                        <label class="form-label" id="place" for="place">Vehicle Type</label>
                        <input type="text" class="form-control" id="place" name="vechi_type" placeholder="enter VehicleType" tabindex="2" pattern="[A-Za-z]+" title="enter characters only" required>
                        
                    </div> 
                        
                        <div class="form-group">
                        <label class="form-label" id="mobileno" for="mobileno">Amount</label>
                        <input type="text" class="form-control" id="mobileno" name="amount" placeholder="enter Amount" tabindex="2" maxlength="10" pattern="[0-9]+" title="enter digits only" required>
...
/*	$qry="select count(*) as cnt from registration where fname='$firstname' and phoneno='$mobileno'";
	...
	$qry2="insert into registration(fname,lname,age,gender,place,email,phoneno,username,licenceproof,licencenumber,vehi_no,status) values('$firstname','$lastname','$age','$gender','$place','$emailid','$mobileno','$username','$file_name','$lnum','$vno','not approved')";
	mysql_query($qry2);
	
	$usertype="staff";
	
	$q="insert into login(username,password,usertype)values('$username','$pasword','driver')";
	
	mysql_query($q);
	echo $q;
	
	$sql="insert into vechicle(dname,vehi_no,vechi_name,seat_capacity,Vechi_tpe,amount,status) values('$username','$vno','$vname','$seat','$type','$amount','not approved')";
	mysql_query($sql);
	echo $sql;

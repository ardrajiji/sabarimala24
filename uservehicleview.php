...
?>
    ...
    <div class="container py-lg-5 mt-sm-5 mt-3">
      ...
      <div class="row py-md-5 py-sm-3">
        <div class="col-md-6">
			...
			$qry="select username,phoneno from signup where username='$username'"; 
			$rs=mysql_query($qry);
 ...
 if(isset($_REQUEST['sub']))
 {
 	...
 	$qry="select status from vehiclebooking where phno='$phno'";
 	...
 	if($rs['status']==1)
 	{
	 /*$qry="select class,noofpersons from darshanambooking where phno='$phno'";

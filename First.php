...
<body>
  ...
  <img src="Payment/Images/1391796960_payment_method_card_visa.png" alt="Smiley face" height="31" width="58"><input type="radio" name="test" value="small" checked>
  <img src="Payment/Images/1391796956_payment_method_master_card.png" alt="Smiley face" height="31" width="58"> </td>
            <td>&nbsp;</td>
        </tr>
        <form>
        <tr>
	...
	if(isset($_REQUEST["sub"]))
	{
		...
		$b = $_SESSION['bookid'];
		$q1 = "update table_booking set status = 'Paid' where bid = '$b'";
		mysql_query($q1);
		$pid = $_SESSION['phid'];
		$q2 = "insert into table_payment(custid,phid,amount) values('$uid','$pid','5000')";
		mysql_query($q2);
